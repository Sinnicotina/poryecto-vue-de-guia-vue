                ...
                <form @submit.prevent="saveComuna">
                    <div class="row bm-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="comu_codi" class="form-control" placeholder="Código comuna" disabled
                    ...
                    <div class="row bm-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="comu_nomb" class="form-control" placeholder="Código comuna"
                    ...
                    <div class="row bm-3">
                        ...
                        <label for="comu_codi" class="form-label">Municipio : </label>
                        <div class="input-group">
